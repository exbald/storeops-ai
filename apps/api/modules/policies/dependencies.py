...
from apps.api.modules.policies.repository import (
    InMemoryPolicyRepository,
    PolicyRepository,
)
from apps.api.modules.policies.service import PolicyService
...
def get_policy_repository() -> PolicyRepository:
    ...
    if _policy_repository is None:
        _policy_repository = InMemoryPolicyRepository()
    return _policy_repository


def set_policy_repository(repo: PolicyRepository) -> None:
    global _policy_repository
